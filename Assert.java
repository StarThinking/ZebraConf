...
public class Assert {
    ...
    static {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(new File(reconf_systemRootDir + "reconf_vvmode")));
	...
	if (reconf_vvmode.equals("v1v2")) {
            System.out.println("msx-assert akip throw Exception in fail() when reconf_vvmode is " + reconf_vvmode);
	    return;
	}
        if (message == null) {
    ...
    static public void assertEquals(String message, Object expected,
            Object actual) {
	if (reconf_vvmode.equals("v1v2")) {
            System.out.println("msx-assert akip throw Exception in assertEquals() when reconf_vvmode is " + reconf_vvmode);
	    return;
	}
