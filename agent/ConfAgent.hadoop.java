...
public class ConfAgent {
	...
	myPrint("DEBUG: try to registerMyComponent componentObj = " + componentObj.hashCode() + ", componentGroup = " + componentGroup
        ...
        try {
            ...
            if (entryRegistered != null) {
                ...
                myPrint("WARN: registered component " + entryRegistered.componentWithIndex() + " with node id " +
		    componentObj.hashCode() + " is being registered again. just return the root (unique) conf");

		// always return the root/unique conf of exisiting registered component object
		return entryRegistered.rootConf;
            } else {
                ...
                myInfoPrint("registerMyComponent for comoponent " + newComponentConf.componentWithIndex() +  " with node id " + 
                    componentObj.hashCode() + " with uniqueConf " + uniqueConf.hashCode() + " originConf " + originConf.hashCode());
