...
class Node(object):
    ...
    def copy_config_files(self):
        ...
        logger.warn('[msx] ccmlib:copy_config_files.py, conf_dir = {}'.format(conf_dir))
    ...
    def _update_yaml(self):
        ...
        # msx
        #logger.warn('[msx] _update_yaml, conf_file = {}'.format(conf_file))
        ...
        # msx
        logger.warn('[msx] ccmlib:node.py, self.name = {}'.format(self.name))
        #if self.name == 'node6':
        #    data['sstable_preemptive_open_interval_in_mb'] = 44
        #logger.warn('[msx] ccmlib:node.py, sstable_preemptive_open_interval_in_mb = {}'.format(data['sstable_preemptive_open_interval_in_mb']))
