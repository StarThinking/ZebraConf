...
public class DatabaseDescriptor
{
    ...
    public static Config loadConfig() throws ConfigurationException
    {
        ...
        logger.warn("[msx] DatabaseDescriptor:loadConfig, config.sstable_preemptive_open_interval_in_mb = "
    ...
    */
    ...
    {
        // msx
        logger.warn("[msx] getSSTablePreemptiveOpenIntervalInMB() returns " + conf.sstable_preemptive_open_interval_in_mb);
