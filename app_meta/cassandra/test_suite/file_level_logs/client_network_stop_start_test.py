...
-------------------------------- live log call ---------------------------------
17:03:07,306 ccmlib.node WARNING [msx] ccmlib:copy_config_files.py, conf_dir = /users/masix/cassandra/conf
17:03:07,393 ccmlib.node WARNING [msx] ccmlib:node.py, self.name = node1
17:03:07,462 ccmlib.node WARNING [msx] ccmlib:node.py, self.name = node1
PASSED                                                                   [ 33%]
